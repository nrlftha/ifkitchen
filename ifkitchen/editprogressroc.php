...
<center>
    ...
    if(isset($_POST['submit'])){
        ...
        $res = "UPDATE roc SET  empno='$empno', sd='$sd', branch='$branch', name='$name', notel='$notel',  summary='$summary',  bw='$bw',  color='$color', 
         technical='$technical',  worktop='$worktop',  bq='$bq',  a3='$a3',  quotation='$quotation', checklist='$checklist',  keyin='$keyin',  snapshot='$snapshot', sverify='$sverify' WHERE id=$id";
        // echo $res; exit;
        $result=$conn->query($res);

        header("location: progressroc.php?id={$id}");
...
<input type="checkbox" name="worktop" value="Worktop"> Worktop<br />
 ...
 <tr>
 <th>Submit Order :</th>
 <td><input type="date" name="sverify" value="<?php echo $sverify ;?>" required></td>
 </tr>
 <tr>
