...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO roc(id,empno,sd,branch,name,notel) 
    VALUES ('$id','$empno','$sd','$branch','$name','$notel')";
		...
		<tbody><tr>
         ...
         <?php if ($rows['snapshot'] != "") {
            ...
            <td colspan="2" align="center">
                <input type="button" value=" View " onclick="window.location.href='viewroc.php?id=<?php echo $rows['id'];?>'"/>
                 
				<a href="delete.php?id=<?php echo $rows['id'];?>" onclick=" return confirm ('Are you sure to delete this user?')"><input type="button" value="Delete"/>
                </a>
		  </td>
