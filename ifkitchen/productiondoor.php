...
if(isset($_POST['submit'])){
  ...
  $insert = "INSERT INTO productiondoor(empno,pintu,handle,jcolor,accessories,remark,color,jhandle,carcase,papan,opintu) 
  VALUES ('$empno','$pintu','$handle','$jcolor','$accessories', '$remark','$color','$jhandle','$carcase','$papan','$opintu')";
