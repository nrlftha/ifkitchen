...
$empno = $pintu = $handle = $jcolor = "";
$accessories = $remark = $color = $jhandle = $carcase = $papan = $opintu = "";*/
...
if(isset($_POST['submit'])){
  ...
  $insert = "INSERT INTO productiondoor(empno,pintu,handle,jcolor,accessories,remark,color,jhandle,carcase,papan,opintu,door_carcase) 
  VALUES ('$empno','$pintu','$handle','$jcolor','$accessories', '$remark','$color','$jhandle','$carcase','$papan','$opintu','$door_carcase')";
  $row = mysqli_insert_id($conn);
  $result = mysqli_query($conn, $insert, $row);

  header("location: resultproduction.php");
...
if (isset($_POST['submit'])){
    ...
    $insert = "UPDATE progress SET door_carcase='$door_carcase' WHERE customerno='$empno'";
    $res = mysqli_query($conn,$insert);

    header("location: progressproduction.php");
}
?>
<center>
...
<form method="post" action="">
 <table id = "t01">
 <tr>
 <th colspan="2"><h2>Production Door & Carcase Report Details</h2></th>
 </tr>
 <tr>
 <th>C/O </th>
...
<tr>
<th><label for="pintu">Jenis Pintu </label>  </th>
<td>
<select name="pintu" id="pintu">
...
<tr>
<th><label for="handle">Jenis Handle </label></th> 
...
<tr>
<th><label for="jcolor">Jenis Color </label></th>
...
<th>Submit Door Carcase </th>
 <td><input type="date" name="door_carcasse" required></td>
 </tr>
<tr>
