  ...
  $empno = $sorder = $sverify = $door_carcase = $part_goods = $payment = $delivery = $carcase_installation
   ...
   <div class="progress">
    ...
    <table border="1" cellpadding="5" align="center">
		  ...
		  <td>
                <a href= "viewprogressroc.php?idprogress=<?php echo $row['idprogress'];?>">View</a>
                <br><br>
                <a href= "editprogressroc.php?idprogress=<?php echo $row['idprogress'];?>">Edit</a>
                <br><br>
				<a href="deleteprogressroc.php?idprogress=<?php echo $row['idprogress'];?>" onclick=" return confirm ('Are you sure to delete this user?')">Delete</a>
		  </td>            
        </tr>
