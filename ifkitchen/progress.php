...
$customerno=$_GET['customerno']; //get empno value from the url and assign it to the value variable $empno

//SQL command for SELECT
$cmdselect="SELECT * FROM daftar_customer WHERE customerno='$customerno'"; //select row based on $empno value only
