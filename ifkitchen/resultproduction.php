...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO productiondoor(idproduction,empno,pintu,handle,jcolor,door_carcase) 
    VALUES ('$idproduction','$empno','$pintu','$handle','$jcolor','$door_carcase')";
...
<?php
    ...
    <td><?=$rows['door_carcase']?></td>
            <td colspan="2" align="center">

                <input type="button" value=" View " onclick="window.location.href='displayproduction.php?idproductiondoor=<?php echo $rows['idproductiondoor'];?>'"/>
                 
				<a href="deleteproduction.php?idproductiondoor=<?php echo $rows['idproductiondoor'];?>" onclick=" return confirm ('Are you sure to delete this user?')"><input type="button" value="Delete"/>
                </a>
